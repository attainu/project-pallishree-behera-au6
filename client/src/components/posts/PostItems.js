...
const PostItems = ({
    ...
    deletePost,
    auth,
    post: { _id, text, name, pic, user, likes, comments, date },
    showActions
}) => {
    return (
        <div className="row">
