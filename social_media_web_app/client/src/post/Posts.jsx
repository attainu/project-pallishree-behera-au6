          ...
          return (
            <div className="card col-md-5 offset-3 my-2" key={i}>
              <div className="card-body">
                ...
                <h4 style={{color:'#30336b'}}> {posterName.toUpperCase()} </h4>
                <p className="font-italic text-muted small">{new Date(post.created).toDateString()}</p>
                <img
  ...
  render() {
    ...
    return (
      <div className="container">
        <h2 className="mt-5 mb-5" style={{color:'#30336b'}}>
